   ...
   <!--  <div class="color-switcher-toggle animated pulse infinite">
    ...
    <div class="container-fluid">
      <div class="row" >
        ...
        <!-- End Main Sidebar -->
        <main class="main-content col-md-12" style="padding-left: 0px; padding-right: 0px;">
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
              <div class=" w-100 d-none d-md-flex d-lg-flex">
                ...
                <label style="padding-left: 30px; padding-top: 10px; font-size: 20px; font-weight: 700;">Smart Farm </label> 
                <a href="<?= url('/')?>/dashboard1?id=<?= $_GET['id'] ?>"><label style="padding-left: 30px; padding-top: 15px; cursor: pointer;">IOT Sensor</label></a>
                <a href="<?= url('/')?>/dashboard2?id=<?= $_GET['id'] ?>"><label style="padding-left: 30px; padding-top: 15px; cursor: pointer;">Alert</label></a>
                <a href="<?= url('/')?>/dashboard3?id=<?= $_GET['id'] ?>"><label style="padding-left: 30px; padding-top: 15px; cursor: pointer;">MultiSpectra Image Analysis</label></a>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-md-inline-block">
                      <?php
                          ...
                          $id = Auth::id();
                          $fullname = DB::table('users')->where('id',$id)->first();
                  ...
                  <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="<?= url('/')?>/home">
                      <i class="material-icons">&#xE7FD;</i> Manage Farm</a>
                    <a class="dropdown-item" href="<?= url('/')?>/data_configuration">
                      <i class="material-icons">vertical_split</i> Data Configuration</a>
                    <a class="dropdown-item" href="<?= url('/')?>/create_user">
                      <i class="material-icons">note_add</i> Manage Customer</a>
          ...
          <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
            ...
            <span class="copyright ml-auto my-auto mr-2">Copyright © 2022
              <a href="https://designrevision.com" rel="nofollow">Nexquadarant Sdn Bhd</a>
            </span>
          </footer>
        </main>
      </div>
